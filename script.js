...
const PLOT_DATA = [
    {
        id: 'plot-75',
        sizeCategory: '75-sqyd',
        title: 'Executive Villa Plot',
        sqyd: '75 Sq. Yds.',
        sqft: '675 Sq. Ft.',
        dimensions: '18.75\' x 36\'',
        floorPermission: 'Stilt + 4 Floors',
        facing: 'East / North-East',
        registry: 'Individual Floor Registry',
        price: '₹ 65.5 Lakhs*',
        badge: 'Selling Fast',
        description: 'Ideal for bespoke low-rise floors or single-family executive homes with private terrace & stilt parking.'
    },
    {
        id: 'plot-100',
        sizeCategory: '100-sqyd',
        ...
        description: 'Versatile layout offering maximum floor space efficiency and high rental yield for luxury floors.'
    },
    {
        id: 'plot-125',
        sizeCategory: '125-sqyd',
        title: 'Luxury Parkview Plot',
        sqyd: '125 Sq. Yds.',
        sqft: '1,125 Sq. Ft.',
        dimensions: '22.5\' x 50\'',
        floorPermission: 'Stilt + 4 Floors',
        facing: 'Overlooking Central Park',
        registry: 'Individual Floor Registry',
        price: '₹ 1.10 Crore*',
        badge: 'Park Facing',
        description: 'Prime location plot adjacent to central greens and jogging trail. Unobstructed views & lush ambient air.'
    },
    {
        id: 'plot-150',
        sizeCategory: '150-sqyd',
        title: 'Signature Estate Plot',
        sqyd: '150 Sq. Yds.',
        sqft: '1,350 Sq. Ft.',
        dimensions: '25\' x 54\'',
        floorPermission: 'Stilt + 4 Floors',
        facing: 'Corner / Dual Frontage',
        registry: 'Individual Floor Registry',
        price: '₹ 1.35 Crore*',
        badge: 'Limited Edition',
        description: 'Expansive corner plot with dual road access. Ample natural light, private garden space, and high ceiling potential.'
    },
    {
        id: 'plot-179',
        sizeCategory: '179-sqyd',
        title: 'Royal Ambassador Plot',
        sqyd: '179 Sq. Yds.',
        sqft: '1,611 Sq. Ft.',
        dimensions: '30\' x 53.7\'',
        floorPermission: 'Stilt + 4 Floors',
